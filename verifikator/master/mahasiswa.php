                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                           <button type="button" class="btn btn-success waves-effect m-r-20" data-toggle="modal" data-backdrop="static" data-keyboard="false" id="btn-tambah" data-target="#form-modal" style="display: none;">Tambah Data <i class="material-icons" style="font-size:16px;" >playlist_add</i></button><br><br>
        ...
        <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group fr1">
                                            <select id="ilmu" class="form-control">
                                                ...
                                                <option value="1">Eksak</option>
                                                <option value="2">Non Eksak</option>
                                            </select>
                        ...
                        <div class="modal-footer"> 
                            ...
                            <button type="submit" class="btn btn-danger waves-effect" id="btn-simpan" class="close" data-dismiss="modal">TUTUP</button>
                        </div>
                    </div>
                </div>
            </div>
