                        ...
                        <div class="body" id="tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="permohonan">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line fr1">
                                               <input type="text" id="ipk" name="ipk" class="form-control" required placeholder="Masukkan IPK Terakhir">
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas1">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="kk" name="kk" class="form-control fc" data-no="6" data-v="v14" placeholder="Masukkan Scan Kartu Keluarga" required>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas2">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="domisili" name="domisili" class="form-control fc" data-no="8" data-v="v15" placeholder="Masukkan Surat Domisili" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="suratN" name="suratN" class="form-control fc" data-no="9" data-v="v16" placeholder="Masukkan Surat Bebas Narkoba" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat1" name="sertifikat1" class="form-control fc" data-no="10" data-v="v17" placeholder="Masukkan Sertifikat 1 *Jika ada" required>
                                        </div>
                                            <div class="help-info">*Sertifikat prestasi/kejuaraan/lomba</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat2" name="sertifikat2" class="form-control fc" data-no="11" data-v="v18" placeholder="Masukkan Sertifikat 2 *Jika ada" required>
                                        </div>
                                            <div class="help-info">*Sertifikat prestasi/kejuaraan/lomba</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat3" name="sertifikat3" class="form-control fc" data-no="12" data-v="v19" placeholder="Masukkan Sertifikat 3 *Jika Ada" required>
                                        </div>
                                            <div class="help-info">*Sertifikat prestasi/kejuaraan/lomba</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="burek" name="burek" class="form-control fc" data-no="13" data-v="v20" placeholder="Masukkan Scan Buku Rekening" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="ijazah" name="ijazah" class="form-control fc" data-no="14" data-v="v21" placeholder="Masukkan Scan Ijazah Pendidikan Terakhir" required>
                                        </div>
