...
?>
                                ...
                                <table class="table table-bordered table-striped table-hover" id="example" style="margin-right:0px;">
                                    ...
                                    //$periode = @$_GET['prd'];
                                    //    if ($periode == "") {
                                            $sql = $con->prepare("SELECT b.*, m.nama_mahasiswa, m.foto_mahasiswa, m.daerah, m.ilmu, m.jenjang FROM beasiswa_coass b, mahasiswa m WHERE b.id_mahasiswa=m.id_mahasiswa AND (b.status_perbaikan='2' AND b.verifikator='$verifikator' AND periode='$dpr')");
