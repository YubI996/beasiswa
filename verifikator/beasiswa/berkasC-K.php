            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            <h2>
                                DATA PERBAIKAN BERKAS BEASISWA COASS KEDOKTERAN
                            </h2>
                        </div>
                        ...
                        <div class="body" id="tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="permohonan">
                                        ...
                                        <div class="form-group">
                                                <select id="id_mahasiswa" disabled="" class="form-control" data-live-search="true">
                                        ...
                                        <div class="form-group">
                                                <select id="periode" disabled="" class="form-control" data-live-search="true">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line fr1">
                                               <input type="text" disabled="" id="tgl" name="tgl" class="datepicker form-control" required placeholder="Masukkan Tanggal Permohonan">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line fr1">
                                               <input type="text" disabled="" id="semester" name="semester" class="form-control" required placeholder="Masukkan Semester Saat ini">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line fr1">
                                               <input type="text" disabled="" id="ipk" name="ipk" class="form-control" required placeholder="Masukkan IPK Terakhir">
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas1">
                                    ...
                                    <label for="user">Proposal Penelitan Asli (Legalisir)</label>
                                    ...
                                    <label for="user">Proposal Penelitan Asli (Disetujui Pembimbing)</label>
                        ...
                        <div class="body" id="tabs">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas">
                                    ...
                                    <label for="user">Proposal Penelitian Asli (Disetujui Pembimbing)</label>
...
?>
    <script src="berkasC-K.js"></script>
