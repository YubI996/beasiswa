                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <center><a href="surat-permohonan.php?ktg=cs" target="_new" class="btn btn-danger"><i class="material-icons">assignment</i> DOWNLOAD SURAT PERMOHONAN BEASISWA COASS</a></center><br>
                            <center><a src="permohonan dan pernyataan.docx" target="_new" class="btn btn-warning"  download><i class="material-icons">assignment</i> DOWNLOAD SURAT PERMOHONAN BEASISWA</a></center>
                            <?php
                             }
                            ?>
                        ...
                        success: function(response){  
                            ...
                            if (response.status == 'acc') { 
                                swal({
                                        ...
                                        text: "Berkas Anda telah diverifikasi dan dinyatakan <b>LENGKAP</b>. Mohon untuk mengirimkan <b>BERKAS ASLI</b> permohonan beasiswa Anda ke Bagian Kesra Sekretariat LPTQ, Stadion Lapangan Bessai Berinta Kota Bontang, Jalan. KS. Tubun, Kelurahan, Kel. Api-Api, Bontang Utara.",
