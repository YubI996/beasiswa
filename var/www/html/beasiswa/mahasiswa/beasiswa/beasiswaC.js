...
$('.fc3').on('change', function(){ // on change of state
        ...
        $("#btn-simpan3").click(function(){ // Ketika tombol simpan di klik
            ...
            if ((aks == 'edt' && $("#cSTA3").is(':checked') && suratTA == "") || (aks == 'add' && suratTA == "")) {
                errorFocus(5, 13, '.frrr', 'vv741', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(5, '.frrr', 'vv741');
            }
            if ((aks == 'edt' && $("#cKhs3").is(':checked') && khs == "") || (aks == 'add' && khs == "")) {
                errorFocus(6, 13, '.frrr', 'vv81', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(6, '.frrr', 'vv81');
            }
            if ((aks == 'edt' && $("#cSK3").is(':checked') && suratK == "") || (aks == 'add' && suratK == "")) {
                errorFocus(7, 13, '.frrr', 'vv91', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(7, '.frrr', 'vv91');
            }
            // if ((aks == 'edt' && $("#cSB3").is(':checked') && suratB == "") || (aks == 'add' && suratB == "")) {
            //     errorFocus(8, 13, '.frrr', 'vv101', 'Field tidak boleh kosong');
            //     return false;
            // }else{
            //     errorClear(8, '.frrr', 'vv101');
            // }
            if ((aks == 'edt' && $("#cKtm3").is(':checked') && ktm == "") || (aks == 'add' && ktm == "")) {
                errorFocus(9, 13, '.frrr', 'vv111', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(9, '.frrr', 'vv111');
            }
            ...
            if ((aks == 'edt' && $("#cKk3").is(':checked') && kk == "") || (aks == 'add' && kk == "")) {
                errorFocus(10, 14, '.frrr', 'vv141', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(10, '.frrr', 'vv141');
            }
            if ((aks == 'edt' && $("#cKtp3").is(':checked') && ktp == "") || (aks == 'add' && ktp == "")) {
                errorFocus(11, 14, '.frrr', 'vv131', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(11, '.frrr', 'vv131');
            }
            if ((aks == 'edt' && $("#cDom3").is(':checked') && domisili == "") || (aks == 'add' && domisili == "")) {
                errorFocus(12, 14, '.frrr', 'vv151', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(12, '.frrr', 'vv151');
            }
            // if ((aks == 'edt' && $("#cSN3").is(':checked') && suratN == "") || (aks == 'add' && suratN == "")) {
            //     errorFocus(13, 14, '.frrr', 'vv161', 'Field tidak boleh kosong');
            //     return false;
            // }else{
            //     errorClear(13, '.frrr', 'vv161');
            // }
            if (aks == 'edt' && $("#cS13").is(':checked') && sertifikat1 == "") {
                errorFocus(14, 14, '.frrr', 'vv171', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(14, '.frrr', 'vv171');
            }
            if (aks == 'edt' && $("#cS23").is(':checked') && sertifikat2 == "") {
                errorFocus(15, 14, '.frrr', 'vv181', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(15, '.frrr', 'vv181');
            }
            if (aks == 'edt' && $("#cS33").is(':checked') && sertifikat3 == "") {
                errorFocus(16, 14, '.frrr', 'vv191', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(16, '.frrr', 'vv191');
            }
            if ((aks == 'edt' && $("#cBR3").is(':checked') && burek == "") || (aks == 'add' && burek == "")) {
                errorFocus(17, 14, '.frrr', 'vv201', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(17, '.frrr', 'vv201');
            }
            if ((aks == 'edt' && $("#cIjz13").is(':checked') && ijazah1 == "") || (aks == 'add' && ijazah1 == "")) {
                errorFocus(18, 14, '.frrr', 'vv211', 'Field tidak boleh kosong');
                return false;
            }else{
                errorClear(18, '.frrr', 'vv211');
            }
            if (aks == 'edt' && $("#cIjz23").is(':checked') && ijazah2 == "") {
                errorFocus(19, 14, '.frrr', 'vv231', 'Field tidak boleh kosong');
                return false;
            }else{
                    errorClear(19, '.frrr', 'vv231');
           ...
           //jika lolos validasi lanjut ke proses simpan data
            ...
            $("#loading-simpan3").show(); // Munculkan loading simpan
        ...
        $(".viewfile13").click(function(){ // Ketika tombol view di klik
            ...
            if(filedata === 'jpg' || filedata === 'jpeg' || filedata === 'png' || filedata === 'gif'){
                var vf = '<i class="material-icons md-18">cloud_download</i> Download File : <a href="https://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_cs/'+ data1+'" download>'+data1+'</a><hr><img src="https://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_cs/'+ data1 +'" style="height:auto; width:100%; ">'; //jika berekstensi gambar tampilkan sebagai gambar
                document.getElementById('view-file3').innerHTML = vf;
            }
            else if(filedata === 'pdf'){ //jika berekstensi pdf tampilkan sebagai file pdf
                document.getElementById('view-file3').innerHTML = '<i class="material-icons md-48">cloud_download</i><br> Download File : <a href="https://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_cs/'+ data1+'" download>'+data1+'</a>';
