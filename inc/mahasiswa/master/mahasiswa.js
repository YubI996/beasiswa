...
function errorClear(idFL, classFl, idpesan){
		...
		$("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
            ...
            var re1 = /^[0-9]+$/;
			var nama = document.getElementById("nama").value; //validasi data kosong
			var ktm = document.getElementById("ktm").value; //validasi data kosong
			var ktp = document.getElementById("ktp").value; //validasi data kosong
			var tpl = document.getElementById("tpl").value; //validasi data kosong
			var tgl = document.getElementById("tgl").value; //validasi data kosong
			var kota = document.getElementById("kota").value; //validasi data kosong
			var alamatS = document.getElementById("alamatS").value; //validasi data kosong
			var alamatKtp = document.getElementById("alamatKtp").value; //validasi data kosong
			var telp1 = document.getElementById("telp1").value; //validasi data kosong
			var ayah = document.getElementById("ayah").value; //validasi data kosong
			var ibu = document.getElementById("ibu").value; //validasi data kosong
			var alamatO = document.getElementById("alamatO").value; //validasi data kosong
			var telp2 = document.getElementById("telp2").value; //validasi data kosong
			var pt = document.getElementById("pt").value; //validasi data kosong
			var alamatP = document.getElementById("alamatP").value; //validasi data kosong
			var telp3 = document.getElementById("telp3").value; //validasi data kosong
			var jenjang = document.getElementById("jenjang").value; //validasi data kosong
			var angkatan = document.getElementById("angkatan").value; //validasi data kosong
			var fakultas = document.getElementById("fakultas").value; //validasi data kosong
			var ps = document.getElementById("ps").value; //validasi data kosong
			var jurusan = document.getElementById("jurusan").value; //validasi data kosong
            var ilmu = document.getElementById("ilmu").value;
			var nmbank = document.getElementById("nmbank").value; //validasi data kosong
			var alamatB = document.getElementById("alamatB").value; //validasi data kosong
			var telp4 = document.getElementById("telp4").value; //validasi data kosong
			var norek = document.getElementById("norek").value; //validasi data kosong
			var pemilik = document.getElementById("pemilik").value; //validasi data kosong
