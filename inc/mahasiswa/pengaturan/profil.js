...
$(document).ajaxError(function(){
    ...
    function CheckExtension(file) {
        ...
        var validFilesTypes = ["gif", "jpg", "jpeg", "png"];
        var filePath = file;
        ...
        return isValidFile;
            ...
            $('#foto').on('change', function(){ // on change of state 
                            if(CheckExtension($('#foto')[0].files[0].name) == false){  //cek tipe file  
        ...
        $("#btn-ubah").click(function(){ // Ketika tombol simpan di klik
            ...
            if($("#cek2").is(':checked') && CheckExtension($('#foto')[0].files[0].name) == false){  //cek tipe file  
                $('#v6').html('Tipe file tidak didukung!');
                $('#foto').focus();
                $('#ftt').addClass('error');
                return false; 
