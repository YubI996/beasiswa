                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas1">
                                    ...
                                    *Maks. ukuran file 5 MB<br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="propPN2" name="propPN2" class="form-control fc" data-no="4" data-v="v73" placeholder="Masukkan Proposal Penelitian Yang Disetujui Pembimbing" required>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="berkas2">
                                    ...
                                    *Maks. ukuran file 5 MB<br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="kk" name="kk" class="form-control fc" data-no="12" data-v="v14" placeholder="Masukkan Scan Kartu Keluarga" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="domisili" name="domisili" class="form-control fc" data-no="13" data-v="v15" placeholder="Masukkan Surat Domisili" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="suratN" name="suratN" class="form-control fc" data-no="14" data-v="v16" placeholder="Masukkan Surat Bebas Narkoba" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat1" name="sertifikat1" class="form-control fc" data-no="15" data-v="v17" placeholder="Masukkan Sertifikat 1 *Jika ada" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat2" name="sertifikat2" class="form-control fc" data-no="16" data-v="v18" placeholder="Masukkan Sertifikat 2 *Jika ada" required>
                                        </div>
                                            <div class="help-info">*Sertifikat prestasi/kejuaraan/lomba (Opsional)</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="sertifikat3" name="sertifikat3" class="form-control fc" data-no="17" data-v="v19" placeholder="Masukkan Sertifikat 3 *Jika Ada" required>
                                        </div>
                                            <div class="help-info">*Sertifikat prestasi/kejuaraan/lomba (Opsional)</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="burek" name="burek" class="form-control fc" data-no="18" data-v="v20" placeholder="Masukkan Scan Buku Rekening" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="ijazah1" name="ijazah1" class="form-control fc" data-no="19" data-v="v21" placeholder="Masukkan Scan Ijazah Pendidikan Terakhir" required>
                                        </div>
                                             <span style="color:#f00;font-size:12px;" class="vdt" id="v21"></span>
                                    </div>
                                    <label for="user">Ijazah Pendidika Perguruan Tinggi Sebelumnya</label>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line fr">
                                           <input type="file" id="ijazah2" name="ijazah2" class="form-control fc" data-no="20" data-v="v22" placeholder="Masukkan Scan Ijazah Pendidikan Terakhir" required>
                                        </div>
