...
//-------------------------------------- sub modul -----------------------
if ($page == 'KbeasiswaP' || $page == 'KbeasiswaTA') {
    $smodK = ' class="active"';
}else{
    $smodK = '';    
}
if ($page == 'VbeasiswaP' || $page == 'VbeasiswaTA') {
    $smodV = ' class="active"';
}else{
    $smodV = '';    
}
if ($page == 'PbeasiswaP' || $page == 'PbeasiswaTA') {
    $smodP = ' class="active"';
}else{
    $smodP = '';    
}
...
if ($page == 'KbeasiswaP' || $page == 'KbeasiswaTA' || $page == 'VbeasiswaP' || $page == 'VbeasiswaTA' || $page == 'PbeasiswaP' || $page == 'PbeasiswaTA') {
    $modBE = ' class="active"';
}else{
    $modBE = '';
}
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="#" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapsewww" aria-expanded="false"></a>
                <!--<a href="#" class="bars"></a>-->
                <a class="navbar-brand" href="../user"><img src="../inc/images/<?php echo $logo_user; ?>"></a>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo $modM; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo $pK2; ?>>
                                <a href="../user/master/kriteria.php"><span>&bull; Kriteria Penilaian</span></a>
                            </li>
                            <li <?php echo $pK3; ?>>
                                <a href="../user/master/range.php"><span>&bull; Rentang Penilaian</span></a>
                            </li>
                            <li <?php echo $pB; ?>>
