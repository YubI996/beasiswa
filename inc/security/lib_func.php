...
require_once ($host1."/inc/PHPMailer/src/Exception.php");
require_once ($host1."/inc/PHPMailer/src/PHPMailer.php");
require_once ($host1."/inc/PHPMailer/src/SMTP.php");
...
// $mail->Port = 587;
// $mail->SMTPSecure = 'tls';     
// $mail->Username = 'beasiswabontang2021@gmail.com';
// $mail->Password = 'phpmysql123';
...
<p>Yth '.$nama.',<br />
  Terimakasih telah mendaftar. Silakan aktivasi akun Anda dengan mengklik link aktivasi di bawah ini. (aktivasi hanya berlaku sekali).<br /></p>
    <br />
    <center><a href="https://e-beasiswa.bontangkota.go.id/home/aktivasi_akun.php?uC='.$idUser.'&aC='.$aktivasi.'" style="color:#fff; background:#4584EF; border-radius:5px; border:none; text-decoration:none; padding:8px 20px 8px 20px;"> Aktivasi Akun e-Beasiswa</a></center>
<p>&nbsp;</p>
...
<table style="width: 100%;">
    <tr>
        ...
        <td width="20%"><img src="https://e-beasiswa.bontangkota.go.id/inc/assets/images/acc1.png" style="width:120px; height:auto;"></td>
    </tr>
    <tr>
