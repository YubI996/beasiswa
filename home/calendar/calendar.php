...
<html>
<head>
<title>Cool Event Calendar Widget Flat Responsive Widget Template :: w3layouts</title>
<!--Custom Theme files-->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Cool Event Calendar Widget Responsive, Login form web template,Flat Pricing tables,Flat Drop downs  Sign up Web Templates, Flat Web Templates, Login signup Responsive web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- Custom Theme files -->
<!--web-fonts-->
<link href='../home/calendar/css/fontCal1.css' rel='stylesheet' type='text/css'>
<link href='../home/calendar/css/fontCal2.css' rel='stylesheet' type='text/css'>
<!--//web-fonts-->
<!--Calender-->
<link rel="stylesheet" href="../home/calendar/css/clndr.css" type="text/css" />
<!-- end calender -->
