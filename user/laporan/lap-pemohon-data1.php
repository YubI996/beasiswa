...
include_once ($host1."/inc/security/cek-admin.php");
        ...
        header("Content-Disposition: attachment; filename=Laporan-Data-Pemohon-Beasiswa-".$namafile."_$periodeL.xls");//ganti nama sesuai keperluan
        ...
        header("Expires: 0");
           ...
           <tr>
           <td width="100%" colspan="12" style="border:none;text-align:center;"><h2>DATA PENGAJUAN PERMOHONAN '.$judul.'</h2></td>
           </tr>
           <tr>
