...
include_once ($host1."/inc/mpdf/mpdf.php");
        ...
        $namafile = ($kategori == 'beasiswa_prestasi' ? 'Prestasi' : ($kategori == 'beasiswa_ta' ? 'TA' :  'COASS'));
           ...
           $html ='<table cellpadding="0" cellspacing="0" style="border:none; width:100%;">
           <tr><td style="border:none;" align="left" valign=top><img src="logokota1.jpg" width="50"></td>
           <td width="100%" style="border:none;text-align:center;"><h2>DATA PENERIMA STIMULAN '.$judul.'</h2><h3>PERIODE '. $periodeL.'</h3></td>
...
try {
    ...
    $mpdf->WriteHTML($html);
    $mpdf->Output('Laporan Data Penerima Stimulan '.$namafile. ' Periode '.$periodeL.'.pdf','I');
} catch(Exception $e) {
    echo $e;
    exit;
}?>