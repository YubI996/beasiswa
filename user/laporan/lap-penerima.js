...
$(document).ajaxError(function(){
	...
	$('#kertas').on('change', function(){ // on change of state
		...
		$("#btn-cetak").click(function(){ // Ketika tombol simpan di klik
			...
			var url = 'lap-penerima-data.php?kategori='+d_kategori+'&periode='+d_periode+'&layout='+d_layout+'&kertas='+d_kertas+'&lebar='+d_lebar+'&tinggi='+d_tinggi;
		...
		$("#btn-cetak1").click(function(){ // Ketika tombol simpan di klik
			...
			window.open('lap-penerima-data1.php?kategori='+d_kategori+'&periode='+d_periode+'&layout='+d_layout+'&kertas='+d_kertas+'&lebar='+d_lebar+'&tinggi='+d_tinggi);
		});
