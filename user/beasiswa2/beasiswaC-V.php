                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-line"> 
                                                    <select  id="col2_filter" name="bidang" class="form-control column_filter" data-column="2">
                                                       <option value=''> *Filter Daerah</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-line"> 
                                                   <select  id="col3_filter" name="bidang" class="form-control column_filter" data-column="3">
                                                       <option value=''> *Filter Bidang Ilmu</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="form-line"> 
                                                   <select  id="col4_filter" name="jenjang" class="form-control column_filter" data-column="4">
                                                       <option value=''> *Filter Jenjang</option>
                                                       <option value="d3">D3</option>
                                                       <option value="d4">D4</option>
                                                       <option value="s1">S1</option>
                                                       <option value="s2">S2</option> 
                                                       <option value="coass">Coass</option> 
                                                   </select>
                                                </div>
                                            </div>                                       
                                        </div>
...
?>
    <script src="beasiswaC-V.js"></script>
