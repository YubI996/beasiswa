   ...
   $("#vR").val(vR);
    ...
    if ($('#V').is(':checked')) {
        ...
        $('#accordion_1, #tnk').hide();
            ...
            var main = "beasiswaTA-V-data.php"; 
...
function errorClear(idFL, classFl, idpesan){
        ...
        $("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
            ...
            $.ajax({
                url: 'beasiswaTA-V-aksi.php', // File tujuan
                ...
                success: function(response){ // Ketika proses pengiriman berhasil
                    ...
                    if(response.status == "sukses"){ // Jika Statusnya = sukses
                        ...
                        $("#view").load('beasiswaTA-V-data.php');
        ...
        $(".viewfile1").click(function(){  
            ...
            if(filedata === 'jpg' || filedata === 'jpeg' || filedata === 'png' || filedata === 'gif'){
                var vf = '<i class="material-icons md-18">cloud_download</i> Download File : <a href="https://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_ta/'+ data1+'" download>'+data1+'</a><hr><img src="file_berkas_ta/'+ data1 +'" style="height:auto; width:100%; ">'; //jika berekstensi gambar tampilkan sebagai gambar
