...
?>
                                ...
                                <table class="table table-bordered table-hover" id="example" style="margin-right:0px;">
                                    ...
                                    //$periode = @$_GET['prd'];
                                    //    if ($periode == "") {
                                            $sql = $con->prepare("SELECT b.*, m.nama_mahasiswa, m.foto_mahasiswa, m.daerah, m.ilmu, m.jenjang FROM beasiswa_prestasi b, mahasiswa m WHERE b.id_mahasiswa=m.id_mahasiswa AND periode='$dpr' ORDER BY FIELD(b.status_verifikasi,'3','0','1','2'), b.ipk DESC, b.tgl_permohonan ASC");
...
<?php  
    $sql = $con->prepare("SELECT * FROM kuotaku WHERE kategori='beasiswa_pr'");
    $sql->execute();
