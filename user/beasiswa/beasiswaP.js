...
$('.fc').on('change', function(){ // on change of state
        ...
        $("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
            ...
            if ((aks == 'edt' && $("#cIjz").is(':checked') && ijazah == "") || (aks == 'add' && ijazah == "")) {
...
//*/
            ...
            if (aks == 'edt') { //jika aksinya edt
                    ...
                    data.append('ipk', ipk); 
                    if ($('#suratP').get(0).files.length !== 0) {
                    data.append('suratP', $("#suratP")[0].files[0]);                 
                    }else{
                    data.append('suratP', $("#suratP-value-" + no).val());
                    }
                    if ($('#suratAK').get(0).files.length !== 0) {
                    data.append('suratAK', $("#suratAK")[0].files[0]);                 
                    }else{
                    data.append('suratAK', $("#suratAK-value-" + no).val());
                    } 
                    if ($('#khs').get(0).files.length !== 0) {
                    data.append('khs', $("#khs")[0].files[0]);                 
                    }else{
                    data.append('khs', $("#khs-value-" + no).val());
                    } 
                    if ($('#suratK').get(0).files.length !== 0) {
                    data.append('suratK', $("#suratK")[0].files[0]);                 
                    }else{
                    data.append('suratK', $("#suratK-value-" + no).val());
                    } 
                    if ($('#suratB').get(0).files.length !== 0) {
                    data.append('suratB', $("#suratB")[0].files[0]);                 
                    }else{
                    data.append('suratB', $("#suratB-value-" + no).val());
                    } 
                    if ($('#ktm').get(0).files.length !== 0) {
                    data.append('ktm', $("#ktm")[0].files[0]);                 
                    }else{
                    data.append('ktm', $("#ktm-value-" + no).val());
                    } 
                    if ($('#ktp').get(0).files.length !== 0) {
                    data.append('ktp', $("#ktp")[0].files[0]);                 
                    }else{
                    data.append('ktp', $("#ktp-value-" + no).val());
                    } 
                    /*if ($('#akta').get(0).files.length !== 0) {
                    data.append('akta', $("#akta")[0].files[0]);                 
                    }else{
                    data.append('akta', $("#akta-value-" + no).val());
                    } */
                    if ($('#kk').get(0).files.length !== 0) {
                    data.append('kk', $("#kk")[0].files[0]);                 
                    }else{
                    data.append('kk', $("#kk-value-" + no).val());
                    } 
                    if ($('#domisili').get(0).files.length !== 0) {
                    data.append('domisili', $("#domisili")[0].files[0]);                 
                    }else{
                    data.append('domisili', $("#domisili-value-" + no).val());
                    } 
                    if ($('#suratN').get(0).files.length !== 0) {
                    data.append('suratN', $("#suratN")[0].files[0]);                 
                    }else{
                    data.append('suratN', $("#suratN-value-" + no).val());
                    } 
                    if ($('#sertifikat1').get(0).files.length !== 0) {
                    data.append('sertifikat1', $("#sertifikat1")[0].files[0]);                 
                    }else{
                    data.append('sertifikat1', $("#sertifikat1-value-" + no).val());
                    } 
                    if ($('#sertifikat2').get(0).files.length !== 0) {
                    data.append('sertifikat2', $("#sertifikat2")[0].files[0]);                 
                    }else{
                    data.append('sertifikat2', $("#sertifikat2-value-" + no).val());
                    } 
                    if ($('#sertifikat3').get(0).files.length !== 0) {
                    data.append('sertifikat3', $("#sertifikat3")[0].files[0]);                 
                    }else{
                    data.append('sertifikat3', $("#sertifikat3-value-" + no).val());
                    } 
                    if ($('#burek').get(0).files.length !== 0) {
                    data.append('burek', $("#burek")[0].files[0]);                 
                    }else{
                    data.append('burek', $("#burek-value-" + no).val());
                    } 
                    if ($('#ijazah').get(0).files.length !== 0) {
                    data.append('ijazah', $("#ijazah")[0].files[0]);                 
                    }else{
                    data.append('ijazah', $("#ijazah-value-" + no).val());
                    }
        ...
        $(".viewfile1").click(function(){  
            ...
            if(filedata === 'jpg' || filedata === 'jpeg' || filedata === 'png' || filedata === 'gif'){
                var vf = '<i class="material-icons md-18">cloud_download</i> Download File : <a href="http://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_pr/'+ data1+'" download>'+data1+'</a><hr><img src="file_berkas_pr/'+ data1 +'" style="height:auto; width:100%; ">'; //jika berekstensi gambar tampilkan sebagai gambar
                document.getElementById('view-file').innerHTML = vf;
            }
            else if(filedata === 'pdf'){ //jika berekstensi pdf tampilkan sebagai file pdf
                document.getElementById('view-file').innerHTML = '<i class="material-icons md-48">cloud_download</i><br> Download File : <a href="http://e-beasiswa.bontangkota.go.id/user/beasiswa/file_berkas_pr/'+ data1+'" download>'+data1+'</a>';
