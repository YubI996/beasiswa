...
?>
                                ...
                                <table class="table table-bordered table-hover" id="example" style="margin-right:0px;">
                                    ...
                                    //$periode = @$_GET['prd'];
                                    //    if ($periode == "") {
                                            $sql = $con->prepare("SELECT b.*, m.nama_mahasiswa, m.foto_mahasiswa, m.daerah, m.ilmu, m.perguruan_tinggi, m.jenjang FROM beasiswa_ta b, mahasiswa m WHERE b.id_mahasiswa=m.id_mahasiswa");
                                            $sql->execute(); // Eksekusi querynya                                          
                                    //    }else{
                                    //        $sql = $con->prepare("SELECT b.*, m.nama_mahasiswa, m.foto_mahasiswa, m.daerah, m.ilmu, m.perguruan_tinggi, m.jenjang FROM beasiswa_ta b, mahasiswa m WHERE b.id_mahasiswa=m.id_mahasiswa AND (b.periode='$periode')");
                                    //        $sql->execute(); // Eksekusi querynya                                                                                      
                                    //    }
                                        ...
                                        while ($d=$sql->fetch()) {
                                            ...
                                            echo '
                                                <tr>
                                                    ...
                                                    <td align="center"><a class="badge bg-purple viewfile" data-toggle="modal" data-backdrop="static" data-keyboard="false" id="view-'.$no.'" data-no="'.$no.'" onclick="viewfile('.$d['id_bta'].')" data-target="#form-file1" style="word-wrap: break-word; word-break: break-all; white-space: normal;">'.$d['nama_mahasiswa'].'</a></td>
                                                    ...
                                                    <a class="badge bg-deep-orange konfirmasi" onclick="hapus('.$d['id_bta'].');">
